...
![Get started with Github Actions](./get-started-with-github-actions.png)

This plops you into a web editor ang gives you a basic example workflow yml file to start with. It looks something like this
```yaml
...
You can run this and then look within your Github Actions for the console output from this example file.
